...
.login_body .login_text{width:100%;height: 40px;border: none;border-bottom: 1px solid #ccc;text-indent: 1em;margin-bottom: 5px;outline: none;}
...
.login_body .login_link a{text-decoration: none;margin: 5px;font-size: 12px;color: #E54847;}
</style>
